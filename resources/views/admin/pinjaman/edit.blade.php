...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            <a href="{{route('pinjaman.create')}}" class="btn btn-primary">Kembali</a>
        </div>
    </div>
</div>
<!--end breadcrumb-->
    ...
    <div class="card-body">
        <form action="{{route('pinjaman.update', $pinjaman->id)}}" method="post">
            ...
            <div class="mb-3">
                ...
                placeholder="Nama Barang" value="{{$pinjaman->barang->nama_barang}}">
            @error('nama_barang')
            ...
            <div class="mb-3">
                ...
                placeholder="Nama Peminjam" value="{{$pinjaman->nama_peminjam}}">
            @error('nama_peminjam')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
            ...
            <div class="mb-3">
                ...
                placeholder="Tanggal pinjam" value="{{$pinjaman->tanggal_pinjam}}">
            ...
            <div class="mb-3">
                ...
                placeholder="Tanggal pengembalian" value="{{$pinjaman->tanggal_pengembalian}}">
            ...
            <div class="mb-3">
                ...
                placeholder="Jumlah" value="{{$pinjaman->jumlah}}">
            @error('jumlah')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
            ...
            <div class="mb-3">
                ...
                placeholder="Status" value="{{$pinjaman->status}}">
            @error('status')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
