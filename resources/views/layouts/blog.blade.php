                  ...
                  <div class="postbox pr-20 pb-50">
                     <article class="postbox__item format-image mb-60 transition-3">
                        <div class="postbox__thumb w-img mb-25">
                           <a href="{{url('blog_detail')}}">
                              <img src="front/assets/img/blog/blog-in-01.jpg" alt="blog-thumg">
                           </a>
                        </div>
                        <div class="postbox__content">
                           ...
                           <h3 class="postbox__title mb-20">
                              <a href="{{url('blog_detail')}}">Lavoratories used for scientic reseach take many froms.</a>
                           </h3>
                           ...
                           <div class="postbox__read-more">
                              <a href="{{url('blog_detail')}}" class="tp-btn tp-color-btn banner-animation">Reade More</a>
                           </div>
                        </div>
                     </article>
                     <article class="postbox__item format-image mb-60 transition-3">
                        <div class="postbox__thumb postbox-active swiper-container w-img p-relative mb-25">
                           <div class="swiper-wrapper">
                              <div class="postbox__slider-item swiper-slide">
                                 <img src="front/assets/img/blog/blog-in-04.jpg" alt="">
                              </div>
                              <div class="postbox__slider-item swiper-slide">
                                 <img src="front/assets/img/blog/blog-in-05.jpg" alt="">
                              </div>
                              <div class="postbox__slider-item swiper-slide">
                                 <img src="front/assets/img/blog/blog-in-06.jpg" alt="">
                              </div>
                           </div>
                        ...
                        <div class="postbox__content">
                           ...
                           <div class="postbox__read-more">
                              <a href="{{url('blog_detail')}}" class="tp-btn tp-color-btn banner-animation">Read More</a>
                           </div>
                        </div>
                     </article>
                     <article class="postbox__item format-video mb-60 transition-3">
                        <div class="postbox__thumb postbox__video p-relative mb-25">
                           <a href="{{url('blog_detail')}}">
                              <img src="front/assets/img/blog/blog-in-03.jpg" alt="">
                           </a>
                        ...
                        <div class="postbox__content">
                           ...
                           <h3 class="postbox__title mb-20">
                              <a href="{{url('blog_detail')}}">Four Ways to Fullfill Your Task For Makes House Beautiful.</a>
                           </h3>
                           <div class="postbox__text mb-30">
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-5 col-md-12">
                  <div class="sidebar__wrapper pl-25 pb-50">
                     ...
                     <div class="sidebar__widget mb-40">
                        ...
                        <div class="sidebar__widget-content">
                           <ul>
                              <li><a href="{{url('blog_detail')}}">Chemistry<span>03</span></a></li>
                              <li><a href="{{url('blog_detail')}}">Forensic science <span>07</span></a></li>
                              <li><a href="{{url('blog_detail')}}">Gemological <span>09</span></a></li>
                              <li><a href="{{url('blog_detail')}}">COvid Analysis <span>01</span></a></li>
                              <li><a href="{{url('blog_detail')}}">Becteriology <span>00</span></a></li>
                              <li><a href="{{url('blog_detail')}}">Angiosperm <span>26</span></a></li>
                           </ul>
                        </div>
                     </div>
                           ...
                           <div class="sidebar__post rc__post">
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{url('blog_detail')}}"><img src="front/assets/img/blog/blog-in-01.jpg" alt="blog-sidebar"></a>
                                 </div>
                                 <div class="rc__post-content">
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="{{url('blog_detail')}}">Don't Underestimate Tree for Furniture</a>
                                    </h3>
                                 </div>
                              </div>
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{url('blog_detail')}}"><img src="front/assets/img/blog/sidebar/blog-sm-2.jpg" alt="blog-sidebar"></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="{{url('blog_detail')}}">Equipping Researchers in the Developing World</a>
                                    </h3>
                                 </div>
                              </div>
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{url('blog_detail')}}"><img src="front/assets/img/blog/sidebar/blog-sm-3.jpg" alt="blog-sidebar"></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="{{url('blog_detail')}}">Things to do before shopping</a>
                                    </h3>
                                 </div>
                              </div>
                              <div class="rc__post d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{url('blog_detail')}}"><img src="front/assets/img/blog/sidebar/blog-sm-4.jpg" alt="blog-sidebar"></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="{{url('blog_detail')}}">Research And Verify of a Quality Product</a>
                                    </h3>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="sidebar__widget mb-55">
                        ...
                        <div class="sidebar__widget-content">
                           <div class="tagcloud">
                              <a href="{{url('blog_detail')}}">Furniture</a>
                              <a href="{{url('blog_detail')}}">Table</a>
                              <a href="{{url('blog_detail')}}">Chair</a>
                              <a href="{{url('blog_detail')}}">Cloths</a>
                              <a href="{{url('blog_detail')}}">Toy</a>
                              <a href="{{url('blog_detail')}}">Suit</a>
                              <a href="{{url('blog_detail')}}">T-Shirt </a>
                              <a href="{{url('blog_detail')}}">Dress</a>
                              <a href="{{url('blog_detail')}}">Wooden</a>
                              <a href="{{url('blog_detail')}}">Clock</a>
                              <a href="{{url('blog_detail')}}">Craft</a>
                              <a href="{{url('blog_detail')}}">Gift</a>
                           </div>
                        </div>
                     </div>
                  </div>
